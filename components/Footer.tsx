...
const Footer = () => {
  return (
    <footer className="flexCenter mb-12">
      <div className="padding-container max-container flex w-full flex-col gap-14 pt-12">
        ...
        <p className="regular-14 w-full text-center text-gray-30">
          2025 CSC | All rights reserved
          <br />
          Website created by:{" "}
          <Link href={"https://www.instagram.com/nxcrlc/"}>Nermin Ćoralić</Link>
        </p>
      </div>
    </footer>
  );
